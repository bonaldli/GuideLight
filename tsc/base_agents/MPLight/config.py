...
name = 'saved_model_MPLight_single_grid4x41113'
config = {
    "episode": {
    ...
    "environment": {
        ...
        "state_key": [
            'current_phase',
            # 'car_num', 'queue_length', "occupancy", 'flow', 'stop_car_num',
            'pressure',
        ],
        'reward_type': [
            'queue_len', 'wait_time', 'delay_time',
            'pressure',
            #'speed score'
        ]
    },
    "model_save": {
        ...
        "spe_path": "tsc/{}/model_500.pt".format(name)
    },
    "parallel": {
        "num_workers": 1
    }
